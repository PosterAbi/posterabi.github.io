...
# Admin-paneel — levinud probleemid
...
- Kassa sünkroniseerib automaatselt iga ~5 minuti tagant.
- Kontrollige kas kassa arvutil on interneti ühendus.
- Taaskäivitage kassa rakendus.

## Aruanded näitavad valesid numbreid
...
Kui probleem jätkub, võta ühendust: [Kontaktid & tugi](/docs/kontaktid)
